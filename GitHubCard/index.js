...
// user's username = data.login
// user's location = data.location
// address to user's github page = data[html_url]
// user's followers count = data.followers
// user's following count = data.following
// user's bio = data.bio

function githhubCard(data) {
